...
INSERT INTO users (username, email, password_hash, role) VALUES
  ('alice', 'alice@lab.local', '$2b$10$BwZwwStNNPS8k6h9rATvNu9TWiVQQAE4UK4LoduOgrg8tf.ptXjrq', 'member'),
  ('bob',   'bob@lab.local',   '$$2b$10$RPqVMfDaw9RXXv3mRqUOq.w/yovRb16gMMMttfYHIUTQzQfXtYQha',   'member'),
  ('admin', 'admin@lab.local', '$2b$10$e0/TSZMNwlJhLpgLSyjy/OsKcSRZQKPcNpjtjUp6ww/bWkd3GCEsC','admin')
